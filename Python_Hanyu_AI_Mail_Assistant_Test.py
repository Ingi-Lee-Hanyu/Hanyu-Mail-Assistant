...
st.set_page_config(
    ...
    page_icon=r"C:\Users\user\OneDrive\Desktop\한유 AI 메일 비서\한유 AI 메일 비서_통합\Logo_Hanyu.jpg",
    layout="centered"
)
...
if not st.session_state.logged_in:
    ...
    with col2:
        ...
        st.image(r"C:\Users\user\OneDrive\Desktop\한유 AI 메일 비서\한유 AI 메일 비서_통합\Logo_Hanyu.jpg", use_container_width=True) 
    ...
    GEMINI_API_KEY = "AIzaSyCoTmg3k3EXyOii-FEmbLbGYxNIipsQxb0" 
